...
SHUTDOWN_AGENT="$(/opt/agents/format-env-shutdown-javaagent.sh)"
...
: ${JAVA_OPTS:=-showversion ${JAVA_TMP_OPTS} ${DBG_AGENT} ${SHUTDOWN_AGENT} ${JAVA_HEAP_OPTS} ${JAVA_GC_OPTS} ${JAVA_GC_LOG_OPTS} ${JAVA_USER_OPTS}}
